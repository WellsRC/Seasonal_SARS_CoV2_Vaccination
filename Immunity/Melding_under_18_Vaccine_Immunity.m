...
for jj=1:500
    ...
    parfor ii=1:50000
        Log_L(ii,:)=-Likelihood_Vaccine_Immunity_Under_18(x(ii,:),a_boost,b_boost,t_boost,a_range,b_range,t_range,t_lbnd_sd,y_lbnd_sd,var_lbnd_sd,a_lbnd_sd,b_lbnd_sd,x_ref,a_range_sd,b_range_sd,t_range_sd,N_State);
    end
    ct=1;
