...
close all;
clc;
load('Plot_Data_Waning_Natural_Immunity.mat','Y_SD','T_P')

figure('units','normalized','outerposition',[0 0.02 1 1]);
subplot('Position',[0.05,0.58,0.43,0.38])
M_Inf=median(Y_SD,1);

P_Inf=prctile(Y_SD,[2.5 25 75 97.5]);
...
load('Plot_Data_Waning_Vaccine_Immunity_Under_18.mat','Y_SD','T_P');
...
load('Plot_Data_Waning_Vaccine_Immunity_18_59.mat','Y_SD','T_P');
...
load('Plot_Data_Waning_Vaccine_Immunity_60_plus.mat','Y_SD','T_P');
...
print(gcf,['Waning_Immunity_SD.png'],'-dpng','-r600');