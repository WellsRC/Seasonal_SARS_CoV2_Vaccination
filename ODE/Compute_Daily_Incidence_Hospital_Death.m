function [Daily_Incidence,Daily_Hospital,Daily_Death,Age_Cumulative_Incidence,Age_Cumulative_Hospital,Age_Cumulative_Death,Age_Incidence,Age_Hospital,Age_Death]=Compute_Daily_Incidence_Hospital_Death(T,C_Incidence,C_Death,C_Hosp,T_Run,Parameters)

A=length(Parameters.N);
Daily_Incidence=zeros(A,T_Run(end)-T_Run(1));
...
for a=1:A
   Daily_Incidence(a,:)=pchip(T,C_Incidence(:,a),T_Run(2:end))-pchip(T,C_Incidence(:,a),T_Run(1:end-1));
   ...
   Age_Cumulative_Incidence(a,:)=pchip(T,C_Incidence(:,a),T_Snap);
