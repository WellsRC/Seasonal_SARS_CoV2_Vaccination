...
for t_d=1:8    
    ...
    for ii=1:length(NSv)  
        ...
        save(['Two_Dose_ILC_' num2str(Time_Dose) '_days_50_and_older_' num2str(ii) '.mat'],'T_Run','Model_Output','R_WP');
    end
end
...
for t_d=1:8    
    ...
    for ii=1:length(NSv)  
        ...
        save(['Two_Dose_ILC_' num2str(Time_Dose) '_days_50_and_older_UW_' num2str(ii) '.mat'],'T_Run','Model_Output');
    end
end