...
% 
% for ss=1:length(SA_Scenario)
%     load(['Output_SA_' SA_Scenario{ss} '_Unimodal_Winter.mat'],'Filtered_Output_All');
% 
...
% clc;
% 
% load(['Output_SA_Annual_Campaign_Influenza_Like_Coverage_Unimodal_Winter.mat']);
% Baseline_Output_All=Filtered_Output_All;
% Baseline_Output_Large_Winter=Filtered_Output_Large_Winter;
% Baseline_Output_Large_Summer=Filtered_Output_Large_Summer;
% 
% SA_Scenario={'Two_Campaign_Influenza_Like_Coverage_90_days_65_and_older_Unimodal_Winter','Two_Campaign_Influenza_Like_Coverage_120_days_65_and_older_Unimodal_Winter','Two_Campaign_Influenza_Like_Coverage_150_days_65_and_older_Unimodal_Winter','Two_Campaign_Influenza_Like_Coverage_180_days_65_and_older_Unimodal_Winter','Two_Campaign_Influenza_Like_Coverage_210_days_65_and_older_Unimodal_Winter','Two_Campaign_Influenza_Like_Coverage_240_days_65_and_older_Unimodal_Winter','Two_Campaign_Influenza_Like_Coverage_270_days_65_and_older_Unimodal_Winter','Two_Campaign_Influenza_Like_Coverage_300_days_65_and_older_Unimodal_Winter','Two_Campaign_Influenza_Like_Coverage_90_days_50_and_older_Unimodal_Winter','Two_Campaign_Influenza_Like_Coverage_120_days_50_and_older_Unimodal_Winter','Two_Campaign_Influenza_Like_Coverage_150_days_50_and_older_Unimodal_Winter','Two_Campaign_Influenza_Like_Coverage_180_days_50_and_older_Unimodal_Winter','Two_Campaign_Influenza_Like_Coverage_90_days_50_to_64_Unimodal_Winter','Two_Campaign_Influenza_Like_Coverage_120_days_50_to_64_Unimodal_Winter','Two_Campaign_Influenza_Like_Coverage_150_days_50_to_64_Unimodal_Winter','Two_Campaign_Influenza_Like_Coverage_180_days_50_to_64_Unimodal_Winter','Two_Campaign_Influenza_Like_Coverage_210_days_50_and_older_Unimodal_Winter','Two_Campaign_Influenza_Like_Coverage_240_days_50_and_older_Unimodal_Winter','Two_Campaign_Influenza_Like_Coverage_270_days_50_and_older_Unimodal_Winter','Two_Campaign_Influenza_Like_Coverage_300_days_50_and_older_Unimodal_Winter','Two_Campaign_Influenza_Like_Coverage_210_days_50_to_64_Unimodal_Winter','Two_Campaign_Influenza_Like_Coverage_240_days_50_to_64_Unimodal_Winter','Two_Campaign_Influenza_Like_Coverage_270_days_50_to_64_Unimodal_Winter','Two_Campaign_Influenza_Like_Coverage_300_days_50_to_64_Unimodal_Winter'};
% 
% for ss=1:length(SA_Scenario)
%     load(['Output_SA_' SA_Scenario{ss} '.mat'],'Filtered_Output_All','Filtered_Output_Large_Winter','Filtered_Output_Large_Summer');
% 
%     Scenario_Calculations(Filtered_Output_All,[SA_Scenario{ss}]);
% 
%     Comparison_Calculations(Filtered_Output_All,Baseline_Output_All,[SA_Scenario{ss}]);
% end
% 
% 
% % clear;
...
% %     Filtered_Output_Add_V=Filtered_Output_All;
% %     load(['Output_SA_Two_Campaign_Influenza_Like_Coverage_180_days_50_and_older.mat'],'Filtered_Output_All');
% %     Filtered_Output_50_and_older=Filtered_Output_All;
% %     
% %     Marginal_Benefit_Second_Doses(Baseline_Output_All,Filtered_Output_Add_V,Filtered_Output_50_and_older,Baseline_Output_All, SA_Scenario{ss});
% % end
% % 
% % clear;
% % clc;
...
%     Scenario_Calculations(Filtered_Output_All,['All_' SA_Scenario{ss}]);
% 
%     Comparison_Calculations(Filtered_Output_All,Baseline_Output_All,['All_' SA_Scenario{ss} '-Baseline_Continual_Vaccination_Unimodal_Winter']);
% end
% % 
% % clear;
% % clc;
% % 
% % load(['Output_SA_Annual_Campaign_Influenza_Like_Coverage_Unimodal_Winter.mat'],'Filtered_Output_All');
% % Baseline_Output_All=Filtered_Output_All;
% % 
% % SA_Scenario={'Two_Campaign_Influenza_Like_Coverage_90_days','Two_Campaign_Influenza_Like_Coverage_120_days','Two_Campaign_Influenza_Like_Coverage_150_days','Two_Campaign_Influenza_Like_Coverage_180_days','Two_Campaign_Influenza_Like_Coverage_210_days','Two_Campaign_Influenza_Like_Coverage_240_days','Two_Campaign_Influenza_Like_Coverage_270_days','Two_Campaign_Influenza_Like_Coverage_300_days'};
% % 
% % for ss=1:length(SA_Scenario)
% %     load(['Output_SA_' SA_Scenario{ss} '_65_and_older_Unimodal_Winter.mat'],'Filtered_Output_All');
% %     Filtered_Output_65=Filtered_Output_All;
% %     load(['Output_SA_' SA_Scenario{ss} '_50_and_older_Unimodal_Winter.mat'],'Filtered_Output_All');
% %     Filtered_Output_50=Filtered_Output_All;
% %     load(['Output_SA_' SA_Scenario{ss} '_50_to_64_Unimodal_Winter.mat'],'Filtered_Output_All');
% %     Filtered_Output_50_to_64=Filtered_Output_All;
% %     
% %     Marginal_Benefit_Second_Doses(Filtered_Output_65,Filtered_Output_50,Filtered_Output_50_to_64,Baseline_Output_All, [SA_Scenario{ss} '_Unimodal_Winter']);
% % end
% % 
% % clear;
% % clc;
% % 
% % load(['Output_SA_Annual_Campaign_Baseline_Coverage_Unimodal_Winter.mat'],'Filtered_Output_All');
% % Baseline_Output_All=Filtered_Output_All;
% % SA_Scenario={'Two_Campaign_Baseline_Coverage_90_days','Two_Campaign_Baseline_Coverage_120_days','Two_Campaign_Baseline_Coverage_150_days','Two_Campaign_Baseline_Coverage_180_days','Two_Campaign_Baseline_Coverage_210_days','Two_Campaign_Baseline_Coverage_240_days','Two_Campaign_Baseline_Coverage_270_days','Two_Campaign_Baseline_Coverage_300_days'};
% % 
% % for ss=1:length(SA_Scenario)
...
% % for ss=1:length(SA_Scenario)
% %     load(['Output_SA_' SA_Scenario{ss} '_65_and_older.mat'],'Filtered_Output_All');
% %     Test_MB(Filtered_Output_All,Baseline_Output_All,90+30.*(ss-1),SA_Scenario{ss})
% % end
% % 
% % clear;
% % clc;
...
% % for ss=1:length(SA_Scenario)
% %     load(['Output_SA_' SA_Scenario{ss} '_65_and_older_Unimodal_Winter.mat'],'Filtered_Output_All');
% %     Test_MB(Filtered_Output_All,Baseline_Output_All,90+30.*(ss-1),[SA_Scenario{ss} '_Unimodal_Winter'])
% % end
% % 
% % clear;
% % clc;
...
% % for ss=1:length(SA_Scenario)
% %     load(['Output_SA_' SA_Scenario{ss} '.mat'],'Filtered_Output_All');
% %     Peak_vs_Effect(Filtered_Output_All,Baseline_Output_All,SA_Scenario{ss});
% % end
