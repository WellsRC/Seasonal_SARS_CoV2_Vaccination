function [Filtered_Output_Baseline,Filtered_Output_All,Filtered_Output_Large_Winter,Filtered_Output_Large_Summer] = SA_Output(SA_Scenario,Av,ACg)
...
Pks2=R_WP>1.1;
Filtered_Output_Baseline=Output_Peak_Filter_Baseline(Filtered_Output_All,Pks2);
