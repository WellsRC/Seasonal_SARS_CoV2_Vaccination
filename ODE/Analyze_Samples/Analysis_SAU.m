...
for ss=1:length(SA_Scenario)
    ...
    load(['Output_SA_' SA_Scenario{ss} '_50_to_64_Unimodal_Winter.mat'],'Filtered_Output_Unimodal');
    Filtered_Output_Unimodal_50_to_64=Filtered_Output_Unimodal;
...
for ss=1:length(SA_Scenario)
    load(['Output_SA_' SA_Scenario{ss} '_65_and_older_Unimodal_Winter.mat'],'Filtered_Output_Unimodal');
    Marginal_Benefit_65(Filtered_Output_Unimodal,Baseline_Output_All,90+30.*(ss-1),['Unimodal_Winter_' SA_Scenario{ss}])
end
clear;
clc;
