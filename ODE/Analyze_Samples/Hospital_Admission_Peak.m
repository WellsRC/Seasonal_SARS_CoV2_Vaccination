...
wp_1=1./(datenum('December 1, 2022')-datenum('September 1, 2022'));
wp_2=1./(datenum('March 1, 2023')-datenum('May 1, 2023'));

sp_1=1./(datenum('August 31, 2023')-datenum('May 1, 2023'));
...
if((length(dt_pks)>=2))
    ...
    for pp=1:np
       ...
       elseif(dt_pks(pp)>=datenum('May 1, 2023')) && (rand(1)<=sp_1*(dt_pks(pp)-datenum('May 1, 2023')))
           Summer_Peak=1;
           Mag_Peaks(2)=max(m_pks(pp),Mag_Peaks(2));
       end
    end
