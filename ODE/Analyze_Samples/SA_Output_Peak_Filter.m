...
if(strcmp('Vaccine_Waning',SA_Scenario))
    ...
    Filtered_Output_Large_Summer.Continual_Booster.Low_Coverage.Incidence_Cumulative_Count_Compliment_Age=Filtered_Output_Large_Summer.Continual_Booster.Low_Coverage.Incidence_Cumulative_Count_Compliment_Age(R_WP<0,:);
    Filtered_Output_Large_Summer.Continual_Booster.Low_Coverage.Death_Cumulative_Count_Compliment_Age=Filtered_Output_Large_Summer.Continual_Booster.Low_Coverage.Death_Cumulative_Count_Compliment_Age(R_WP<0,:);
    Filtered_Output_Large_Summer.Continual_Booster.Low_Coverage.Hospital_Cumulative_Count_Compliment_Age=Filtered_Output_Large_Summer.Continual_Booster.Low_Coverage.Hospital_Cumulative_Count_Compliment_Age(R_WP<0,:);
end
...
Filtered_Output_Large_Summer.Annual_Booster.High_Coverage.Incidence_Cumulative_Count_Compliment_Age=Filtered_Output_Large_Summer.Annual_Booster.High_Coverage.Incidence_Cumulative_Count_Compliment_Age(R_WP<0,:);
Filtered_Output_Large_Summer.Annual_Booster.High_Coverage.Death_Cumulative_Count_Compliment_Age=Filtered_Output_Large_Summer.Annual_Booster.High_Coverage.Death_Cumulative_Count_Compliment_Age(R_WP<0,:);
Filtered_Output_Large_Summer.Annual_Booster.High_Coverage.Hospital_Cumulative_Count_Compliment_Age=Filtered_Output_Large_Summer.Annual_Booster.High_Coverage.Hospital_Cumulative_Count_Compliment_Age(R_WP<0,:);
...
if(strcmp('Vaccine_Waning',SA_Scenario))
    ...
    Filtered_Output_Large_Winter.Continual_Booster.Low_Coverage.Incidence_Cumulative_Count_Compliment_Age=Filtered_Output_Large_Winter.Continual_Booster.Low_Coverage.Incidence_Cumulative_Count_Compliment_Age(R_WP>0,:);
    Filtered_Output_Large_Winter.Continual_Booster.Low_Coverage.Death_Cumulative_Count_Compliment_Age=Filtered_Output_Large_Winter.Continual_Booster.Low_Coverage.Death_Cumulative_Count_Compliment_Age(R_WP>0,:);
    Filtered_Output_Large_Winter.Continual_Booster.Low_Coverage.Hospital_Cumulative_Count_Compliment_Age=Filtered_Output_Large_Winter.Continual_Booster.Low_Coverage.Hospital_Cumulative_Count_Compliment_Age(R_WP>0,:);
end
...
Filtered_Output_Large_Winter.Annual_Booster.High_Coverage.Incidence_Cumulative_Count_Compliment_Age=Filtered_Output_Large_Winter.Annual_Booster.High_Coverage.Incidence_Cumulative_Count_Compliment_Age(R_WP>0,:);
Filtered_Output_Large_Winter.Annual_Booster.High_Coverage.Death_Cumulative_Count_Compliment_Age=Filtered_Output_Large_Winter.Annual_Booster.High_Coverage.Death_Cumulative_Count_Compliment_Age(R_WP>0,:);
Filtered_Output_Large_Winter.Annual_Booster.High_Coverage.Hospital_Cumulative_Count_Compliment_Age=Filtered_Output_Large_Winter.Annual_Booster.High_Coverage.Hospital_Cumulative_Count_Compliment_Age(R_WP>0,:);
end