...
Filtered_Output_All.SD_Natural_Immunity=Filtered_Output_All.SD_Natural_Immunity(Peaks==1,:,:);
Filtered_Output_All.Inf_Natural_Immunity=Filtered_Output_All.Inf_Natural_Immunity(Peaks==1,:,:);
Filtered_Output_All.SD_Vaccine_Immunity=Filtered_Output_All.SD_Vaccine_Immunity(Peaks==1,:,:);
Filtered_Output_All.Inf_Vaccine_Immunity=Filtered_Output_All.Inf_Vaccine_Immunity(Peaks==1,:,:);
Filtered_Output_All.Susceptible=Filtered_Output_All.Susceptible(Peaks==1,:,:);
