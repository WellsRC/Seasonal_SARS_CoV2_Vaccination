...
for red_2d=0.35:0.15:0.65
    for ii=1:length(NSv)  
        ...
        save(['Two_Dose_ILC_' num2str(Time_Dose) '_days_Reduction_' num2str(100.*red_2d) '_FDA_' num2str(ii) '.mat'],'T_Run','Model_Output');
...
for red_2d=0.35:0.15:0.65
    for ii=1:length(NSv)  
        ...
        save(['Two_Dose_ILC_' num2str(Time_Dose) '_days_Reduction_' num2str(100.*red_2d) '_18_49_' num2str(ii) '.mat'],'T_Run','Model_Output');
