...
for mmv=1:8
   ...
   for strat_s=1:12
       r(strat_s,mmv)=Higher_Cumulative_Count_Month(strat_s,1);
   end
end
...
text(1.9,mean([lbx ubx]),{'Prob. of greater cumulative incidence','than Sept. vaccination campaign'},'HorizontalAlignment','center','Fontsize',18,'Rotation',270);
ylim([lbx ubx]);
axis off;    
