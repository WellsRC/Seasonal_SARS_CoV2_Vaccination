...
N=x(S_n)+x(S_i)+x(S_i2)+x(S_p)+x(S_p2)+x(nvS_p)+x(V)+x(V2)+x(E_n)+x(E_v)+x(E_v2)+x(E_p)+x(E_p2)+x(I_n)+x(I_v)+x(I_v2)+x(I_p)+x(I_p2)+x(R_n)+x(R_i)+x(R_p)+x(R_p2);
...
dxdt(S_n)=omega_R.*x(R_n)+gamma_SD.*x(S_p2)+gamma_SD.*x(nvS_p)-lambda_FI.*x(S_n);
dxdt(E_n)=lambda_FI.*x(S_n)+lambda_FI.*x(S_i)+lambda_FI.*x(S_i2)-sigma_E.*x(E_n);
dxdt(I_n)=sigma_E.*x(E_n)-delta_I.*x(I_n);
dxdt(R_n)=(1-pd).*delta_I.*x(I_n)-omega_R.*x(R_n)+gamma_SD.*x(R_p2)+gamma_SD.*x(R_p);
...
dxdt(CI_v)=(1-eps_V).*lambda_FI.*x(V)+(1-eps_V).*lambda_FI.*x(V2)+lambda_FI.*x(nvS_p)+lambda_FI.*x(S_p)+lambda_FI.*x(S_p2);
dxdt(C_Death)=pd_v.*((1-eps_V).*lambda_FI.*x(V)+(1-eps_V).*lambda_FI.*x(V2)+lambda_FI.*x(nvS_p)+lambda_FI.*x(S_p)+lambda_FI.*x(S_p2))+pd.*(lambda_FI.*x(S_i2)+lambda_FI.*x(S_i)+lambda_FI.*x(S_n));
dxdt(C_Hosp)=ph_v.*((1-eps_V).*lambda_FI.*x(V)+(1-eps_V).*lambda_FI.*x(V2)+lambda_FI.*x(nvS_p)+lambda_FI.*x(S_p)+lambda_FI.*x(S_p2))+ph.*(lambda_FI.*x(S_i2)+lambda_FI.*x(S_i)+lambda_FI.*x(S_n));
