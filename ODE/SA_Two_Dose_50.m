...
for t_d=1:8    
    ...
    save(['Two_Campaign_Baseline_Coverage_' num2str(Time_Dose) '_days_50_and_older.mat'],'T_Run','Model_Output','R_WP');
end
...
for t_d=1:8    
    ...
    save(['Two_Campaign_Influenza_Like_Coverage_' num2str(Time_Dose) '_days_50_and_older_Unimodal_Winter.mat'],'T_Run','Model_Output');
end
...
for t_d=1:8    
    ...
    save(['Two_Campaign_Baseline_Coverage_' num2str(Time_Dose) '_days_50_and_older_Unimodal_Winter.mat'],'T_Run','Model_Output','R_WP');
end
