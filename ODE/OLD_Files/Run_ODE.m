function [T_Run,T_Month_Age,Y_Model] = Run_ODE(T_Run,Parameters)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Influenza coverage: Continual booster campaign
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
vac_s=true; 
[T,Y] = ode15s(@(t,x)SEIRVS(t,x,Parameters.beta_I,Parameters.sigma_E,Parameters.delta_I,Parameters.delta_V,Parameters.gamma_V,Parameters.omega_R,Parameters.eps_V,vac_s,Parameters.psi_V,Parameters.nu_V_Influenza,Parameters.C,pd,pd_v), [min(T_Run) max(T_Run)],  Parameters.X0.Influenza_Campaign, opts);
[Daily_Incidence_Continual_Booster_High_Coverage,Daily_Death_Count_Continual_Booster_High_Coverage,Daily_Incidence_Unvaccinated,Daily_Incidence_Vaccinated,Age_Cumulative_Incidence_Continual_Booster_High_Coverage,Age_Cumulative_Death_Continual_Booster_High_Coverage]=Compute_Daily_Incidence_Death(T,Y,T_Run,T_Month_Age,Parameters);
[Hospital_Admission_Continual_Booster_High_Coverage,Hospital_Prevalence_Continual_Booster_High_Coverage,Hospital_Count_Continual_Booster_High_Coverage,Age_Cumulative_Hospital_Continual_Booster_High_Coverage]=Compute_Hospital(Daily_Incidence_Unvaccinated,Daily_Incidence_Vaccinated,Parameters,T_Run,T_Month_Age);

Y_Model.Continual_Booster.High_Coverage.Incidence=Daily_Incidence_Continual_Booster_High_Coverage;
Y_Model.Continual_Booster.High_Coverage.Death=Daily_Death_Count_Continual_Booster_High_Coverage;
Y_Model.Continual_Booster.High_Coverage.Age_Incidence=Age_Cumulative_Incidence_Continual_Booster_High_Coverage;
Y_Model.Continual_Booster.High_Coverage.Age_Death=Age_Cumulative_Death_Continual_Booster_High_Coverage;
Y_Model.Continual_Booster.High_Coverage.Hospital_Admission=Hospital_Admission_Continual_Booster_High_Coverage;
Y_Model.Continual_Booster.High_Coverage.Hospital_Burden=Hospital_Prevalence_Continual_Booster_High_Coverage;
Y_Model.Continual_Booster.High_Coverage.Hospital_Count=Hospital_Count_Continual_Booster_High_Coverage;
Y_Model.Continual_Booster.High_Coverage.Age_Hospital=Age_Cumulative_Hospital_Continual_Booster_High_Coverage;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% SARS C0V-2 Coverage: Single booster campaign
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
vac_s=false; 
[T,Y] = ode15s(@(t,x)SEIRVS(t,x,Parameters.beta_I,Parameters.sigma_E,Parameters.delta_I,Parameters.delta_V,Parameters.gamma_V,Parameters.omega_R,Parameters.eps_V,vac_s,Parameters.psi_V,Parameters.nu_V_SARSCoV2,Parameters.C,pd,pd_v), [min(T_Run) max(T_Run)],  Parameters.X0.SARSCoV2, opts);
[Daily_Incidence_Annual_Booster_Low_Coverage,Daily_Death_Count_Annual_Booster_Low_Coverage,Daily_Incidence_Unvaccinated,Daily_Incidence_Vaccinated,Age_Cumulative_Incidence_Annual_Booster_Low_Coverage,Age_Cumulative_Death_Annual_Booster_Low_Coverage]=Compute_Daily_Incidence_Death(T,Y,T_Run,T_Month_Age,Parameters);
[Hospital_Admission_Annual_Booster_Low_Coverage,Hospital_Prevalence_Annual_Booster_Low_Coverage,Hospital_Count_Annual_Booster_Low_Coverage,Age_Cumulative_Hospital_Annual_Booster_Low_Coverage]=Compute_Hospital(Daily_Incidence_Unvaccinated,Daily_Incidence_Vaccinated,Parameters,T_Run,T_Month_Age);

Y_Model.Annual_Booster.Low_Coverage.Incidence=Daily_Incidence_Annual_Booster_Low_Coverage;
Y_Model.Annual_Booster.Low_Coverage.Death=Daily_Death_Count_Annual_Booster_Low_Coverage;
Y_Model.Annual_Booster.Low_Coverage.Age_Incidence=Age_Cumulative_Incidence_Annual_Booster_Low_Coverage;
Y_Model.Annual_Booster.Low_Coverage.Age_Death=Age_Cumulative_Death_Annual_Booster_Low_Coverage;
Y_Model.Annual_Booster.Low_Coverage.Hospital_Admission=Hospital_Admission_Annual_Booster_Low_Coverage;
Y_Model.Annual_Booster.Low_Coverage.Hospital_Burden=Hospital_Prevalence_Annual_Booster_Low_Coverage;
Y_Model.Annual_Booster.Low_Coverage.Hospital_Count=Hospital_Count_Annual_Booster_Low_Coverage;
Y_Model.Annual_Booster.Low_Coverage.Age_Hospital=Age_Cumulative_Hospital_Annual_Booster_Low_Coverage;
end
