...
for rr=1:40
    ...
    parfor jj=1:NS
        Red_VWR(jj)=Est_Reduction_Waning_Rate(P_All{jj},AC,C_Death(jj),vac_red,baseline_s,T_Run);
    end
    save(['Baseline_Reduce_Waning_Immunity_65_plus_Vac_reduction=' num2str(100.*vac_red) '.mat'],'Red_VWR');
end