function P_new=Scale_Annual_Vaccination(P_old,vac_scale_influenza)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%55
P_new.vac_int_influenza=P_old.vac_int_annual+(P_old.vac_int_influenza-P_old.vac_int_annual).*(1-vac_scale_influenza);
