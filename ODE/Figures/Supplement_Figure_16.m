...
for Scenario_Indx=1:4
    ...
    for ss=1:8         
        load([temp_cd 'Marginal_Benefit_50_and_older_Large_Summer_Two_Campaign_Influenza_Like_Coverage_' num2str(90+30.*(ss-1)) '_days.mat'])
    ...
    xlim([0.5 8.5]);
    box off
    set(gca,'LineWidth',2,'Tickdir','out','XTick',[1:8],'XTickLabel',xtl,'Yminortick','on','YTick',[0:5],'Xminortick','off','Fontsize',16);
