...
Scenario_Out='All_Baseline_Continual_Vaccination';
...
Scenario_Out='All_Annual_Campaign_Influenza_Like_Coverage';
load([temp_cd 'Model_Output_Summary_' Scenario_Out '.mat']);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Scenario_Out='All_Annual_Campaign_Influenza_Like_Coverage-Baseline_Continual_Vaccination';
fprintf('=========================================================================== \n');
...
fprintf(['Median reduction in total direct costs: ' num2str(M(PRCT==50),'%3.1f') '%% (95%% PI:' num2str(M(PRCT==97.5),'%3.1f') '%%' char(8211) num2str(M(PRCT==2.5),'%3.1f') '%%) \n']);
