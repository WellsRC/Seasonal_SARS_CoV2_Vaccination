...
Y(1,3)=100.*Marginal_Benefit.Average.Cost(end);
Y_Err.LB(1,3)=100.*Marginal_Benefit.PRCT.Cost(PRCT==2.5,end);
Y_Err.UB(1,3)=100.*Marginal_Benefit.PRCT.Cost(PRCT==97.5,end);

Y(2:end,3)=100.*Marginal_Benefit.Average.Cost_Age(1,1:7,end);
Y_Err.LB(2:end,3)=100.*Marginal_Benefit.PRCT.Cost_Age(PRCT==2.5,1:7,end);
Y_Err.UB(2:end,3)=100.*Marginal_Benefit.PRCT.Cost_Age(PRCT==97.5,1:7,end);
