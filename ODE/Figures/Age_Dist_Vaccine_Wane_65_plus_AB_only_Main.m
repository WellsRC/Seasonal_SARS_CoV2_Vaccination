function Age_Dist_Vaccine_Wane_65_plus_AB_only_Main(State_V)
close all;
Scenario='All';
% close all;
temp_cd=pwd;
...
for mm=1:5
    if(mm==1)
        ...
        load([temp_cd 'Comparison_Summary_' Scenario '_Alt-High_Coverage_Annual_Booster_Gamma_Reduction=' num2str(Red_gamma_V(mm)) '_Baseline-Low_Coverage_Continual_Booster-No_Reduction.mat']);
    end
    gg=1;
    if(t_out(1))
...
print(gcf,['Reduce_Vaccine_Waning_Rate_65_' Scenario '_' State_V '_Annual_Booster_only.png'],'-dpng','-r300');
end