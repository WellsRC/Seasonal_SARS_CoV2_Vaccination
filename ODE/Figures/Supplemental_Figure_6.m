function Supplemental_Figure_6()
close all;
temp_cd=pwd;
...
for Scenario_Indx=1:4    
    ...
    for ss=1:8
       load([temp_cd 'Marginal_Benefit_Two_Campaign_Influenza_Like_Coverage_' num2str(td(ss)) '_days_Unimodal_Winter.mat'])
       if Scenario_Indx==1
...
print(gcf,['Supplemental_Figure_6.png'],'-dpng','-r300');
end