function Supplementary_Figure_9()
close all;
temp_cd=pwd;
...
for dd=90:30:300
    ...
    load([temp_cd 'Comparison_Summary_Main_Text_Annual_vs_Two_Dose_65_and_older_' num2str(dd) '_days.mat']);
...
l=legend(XTL,'Location','northwest','NumColumns',4);
...
print(gcf,['Supplementary_Figure_9-65_or_older.png'],'-dpng','-r300');    
end
