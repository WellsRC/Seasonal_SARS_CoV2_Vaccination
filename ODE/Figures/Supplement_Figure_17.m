...
for Scenario_Indx=1:4
    ...
    load([temp_cd 'Marginal_Benefit_Second_Dose_50_to_64_Large_Summer_Two_Campaign_Influenza_Like_Coverage_180_days.mat'])
    for aa=1:6
        if(Scenario_Indx==1)            
    ...
    xtickangle(90);
    set(gca,'LineWidth',2,'tickdir','out','XTick',[1:6 7.25],'XTickLabel',AgeC,'YTick',[0:10:90],'Yminortick','on','Fontsize',16);
    ylim([0 90]);
    xlim([0.5 7.75]);
...
print(gcf,['Supplement_Figure_17.png'],'-dpng','-r300');
end